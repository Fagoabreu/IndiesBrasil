...
export default createRouter()
  ...
  .delete(controller.canRequest("create:game:comment"), deleteHandler)
...
async function deleteHandler(request, response) {
  ...
  const selectedComment = await game.getCommentById(comment_id, user_id);
  if (!selectedComment) {
  ...
  await game.deleteComment(comment_id);
