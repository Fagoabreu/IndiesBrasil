...
function getClientIp(request) {
  ...
  if (forwarded) {
    // nginx usa `proxy_set_header X-Forwarded-For $proxy_add_x_forwarded_for`,
    // que faz append de $remote_addr ao final. A última entrada é a adicionada
    // pelo nosso proxy confiável; as anteriores são controladas pelo cliente
    // e podem ser forjadas. Por isso pegamos a última (right-most).
