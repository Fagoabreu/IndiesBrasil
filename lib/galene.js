 ...
 *
 * Exigências do Galene 1.1 (token/jwt.go):
...
/**
 * Monta o objeto JSON do grupo Galene (arquivo `groups/<room>.json`).
 * @param {string} keyB64 chave HS256 em base64url (authKeys).
 * @param {string} [displayName] nome do estúdio exibido no topo da sala.
 ...
 */
async function ensureRoomProvisioned(roomId, displayName) {
